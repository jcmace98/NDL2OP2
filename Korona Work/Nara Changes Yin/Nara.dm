...
//Summons
	...
	Summoning_Jutsu_Light_Snake
		name="Summoning(Light Snake)"
		icon_state="FuumaTeleportation"
		Deactivate(mob/M)
			src.DelayIt(300,M,"Nin")
			M.Unsummon("Light Snake")
		...
		Activate(mob/M)
			...
			src.Uses+=1
			src.TurnedOn=1
			M.SummoningJutsu("Light Snake",1,1000)
	...
	Summoning_Jutsu_Slugz
		name="Summoning(Slugz)"
		icon_state="FuumaTeleportation"
		Deactivate(mob/M)
			src.DelayIt(300,M,"Nin")
			M.Unsummon("Hawk)
