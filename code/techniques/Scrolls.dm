...
//////Summoning Scroll//////
	Dark_Snake_Summoning_Scroll
		icon_state="Kage Bunshin scroll"
		NameOfJutsu="Summoning Jutsu(Dark Snake)"
		EXPRequired=0
		JutsuObjName="Summoning_Jutsu_Dark_Snake"
		TheDescription="Dark Snake is an evil pet, created to kill.."
		ChakraRequired=1500
		SummonKingdomRequired="Snake"
	Snake_Summoning_Scroll
		icon_state="Kage Bunshin scroll"
		NameOfJutsu="Summoning Jutsu(Snake)"
		EXPRequired=0
		JutsuObjName="Summoning_Jutsu_Light_Snake"
		TheDescription="Snakes, certified to guarantee your kill."
		ChakraRequired=3000
		SummonKingdomRequired="Snake"
	Hawk_Summoning_Scroll
		icon_state="Kage Bunshin scroll"
		NameOfJutsu="Summoning Jutsu(Hawk)"
		EXPRequired=0
		JutsuObjName="Summoning_Jutsu_Hawk"
		TheDescription="Hawk Flying creature, created to attack from above and hunt."
		ChakraRequired=3000
		SummonKingdomRequired="Hawk"
	Toad_Summoning_Scroll
		icon_state="Kage Bunshin scroll"
		NameOfJutsu="Summoning Jutsu(Toad)"
		EXPRequired=0
		JutsuObjName="Summoning_Jutsu_Toad"
		TheDescription="Toads, a loyal animal to summon, they always seem to help out in some way."
		ChakraRequired=3000
		SummonKingdomRequired="Toad"
	Slug_Summoning_Scroll
		icon_state="Kage Bunshin scroll"
		NameOfJutsu="Summoning Jutsu(Slug)"
		EXPRequired=0
		JutsuObjName="Summoning_Jutsu_Slug"
		TheDescription="Slugs, just plain slugs."
		ChakraRequired=3000
		SummonKingdomRequired="Slug"
