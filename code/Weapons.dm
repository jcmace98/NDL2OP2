...
//One-Handed Swords
	Nuibari
		...
		EquipIconUnderlayRight='Icons/New Base/Weapons/Nuibari.dmi'
		EquipIconOverlayRight='Icons/New Base/Weapons/Nuibari.dmi'
		EquipIconUnderlayLeft='Icons/New Base/Weapons/Nuibari.dmi'
		EquipIconOverlayLeft='Icons/New Base/Weapons/Nuibari.dmi'
	MeleeKunai
		name="Melee Kunai"
		icon_state="Kunai"
		HandedWeapon="One"
	...
	ChakraRod
		...
		ChakraDeplters=1
		EquipIconUnderlayRight='Icons/New Base/Weapons/ChakraReceiverU.dmi'
		EquipIconOverlayRight='Icons/New Base/Weapons/ChakraReceiverO.dmi'
		EquipIconUnderlayLeft='Icons/New Base/Weapons/ChakraReceiverU.dmi'
		EquipIconOverlayLeft='Icons/New Base/Weapons/ChakraReceiverO.dmi'
	Tsubaki
		name="Tsubaki"
		icon_state=""
		HandedWeapon="One"
...
//Legendary Blades
	...
	Kiba
		...
		EquipIconUnderlayRight='Kiba.dmi'
		EquipIconOverlayRight='Kiba.dmi'
		EquipIconUnderlayLeft='Kiba.dmi'
		EquipIconOverlayLeft='Kiba.dmi'
//Spears
	Naginata
		name="Naginata"
		icon_state="Naginata"
...
//Ect
	...
	TriSythe
		name="Triple-Bladed Sythe"
		icon_state="Jashin sythe"
		HandedWeapon="Two"
		Health=100
		PercentDamage=23
		PlacementWeight=45
		...
		EquipIconUnderlayRight='Icons/New Base/Weapons/Jashin sythe.dmi'
		EquipIconOverlayRight='Icons/New Base/Weapons/Jashin sythe.dmi'
		EquipIconUnderlayLeft='Icons/New Base/Weapons/Jashin sythe.dmi'
		EquipIconOverlayLeft='Icons/New Base/Weapons/Jashin sythe.dmi'
///////////////////
//Claws
	KnuckleKnives
		name="Knuckle Knives"
	...
	MarkedKunai
		...
		Bump(A)
			...
			if(ismob(A))
				...
				if(prob(5))
					O.Percision+=0.5;if(O.Percision>10) O.Percision=10
...
//
		...
		Bump(A)
			...
			if(ismob(A))
				var/mob/M = A
				if(prob(1))
					O.Percision+=pick(0.5,0.3);if(O.Percision>10) O.Percision=10
				var/ArmorAddUpForM=0
				for(var/obj/Clothes/Headband/CA in M.contents)
					if(CA.worn)
						ArmorAddUpForM+=CA.ArmorAddOn
...
mob/proc
	HealthPack()
		if(src.GateIn=="Life"||src.GateIn=="Wound"||src.GateIn=="Limit"||src.GateIn=="Wonder"||src.InDeathGate==1)
