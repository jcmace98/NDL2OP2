	...
	Door
		...
		verb/Command()
			...
			if(usr.dir==NORTH&&!src.open)
				...
				var/list/HandSeals=list("Tiger","Boar","Rat","Horse","Ram","Snake","Monkey","Hare","Dog","Rooster","Dragon","Ox")
				...
				var/HandsealFour=input("Handseal Four") in HandSeals
				var/HandsealFive=input("Handseal Five") in HandSeals
				usr.icon_state="handseals"
				sleep(5)
				usr.icon_state="running"
				if(HandsealOne=="Tiger"&&HandsealTwo=="Snake"&&HandsealThree=="Dog"&&HandsealFour=="Dragon"&&HandsealFive=="Tiger")
	...
	UchihaClanHideOut
		...
		UchihaTablet5Right
			...
			verb/Command()
				...
				usr.JutsuInLearning="Past Of The Uchiha Clan"
