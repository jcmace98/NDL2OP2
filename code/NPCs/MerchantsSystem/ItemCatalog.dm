	...
	Cancel
		...
		Click()
			...
			for(var/obj/BuyableThings/Supplies/A in usr.client.screen)
				del(A)
			for(var/obj/BuyableThings/BattlePoints/A in usr.client.screen)
				del(A)
			del(src)
			...
			Click()
				...
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Ryo. Do you want to buy it?", text) in list ("Yes","No."))
					if("Yes")
						if(usr.Yen>=src.Price)
							usr<<sound('SFX/click1.wav',0);usr<<sound('SFX/Cash.wav');usr<<"You bought a [src.name]!";usr.Yen-=src.Price
							var/obj/Scrolls/LearningScrolls/Dark_Snake_Summoning_Scroll/B=new();B.loc=usr
							return
						else
							usr<<"Not enough money!";usr<<sound('SFX/click2.wav',0)
					if("No")
			...
			Click()
				...
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Ryo. Do you want to buy it?", text) in list ("Yes","No."))
					if("Yes")
						if(usr.Yen>=src.Price)
							usr<<sound('SFX/click1.wav',0);usr<<sound('SFX/Cash.wav');usr<<"You bought a [src.name]!";usr.Yen-=src.Price
							var/obj/Scrolls/LearningScrolls/Snake_Summoning_Scroll/B=new();B.loc=usr
							return
						else
							usr<<"Not enough money!";usr<<sound('SFX/click2.wav',0)
					if("No")
			...
			Click()
				...
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Ryo. Do you want to buy it?", text) in list ("Yes","No."))
					if("Yes")
						if(usr.Yen>=src.Price)
							usr<<sound('SFX/click1.wav',0);usr<<sound('SFX/Cash.wav');usr<<"You bought a [src.name]!";usr.Yen-=src.Price
							var/obj/Scrolls/LearningScrolls/Hawk_Summoning_Scroll/B=new();B.loc=usr
							return
						else
							usr<<"Not enough money!";usr<<sound('SFX/click2.wav',0)
					if("No")
			...
			Click()
				...
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Ryo. Do you want to buy it?", text) in list ("Yes","No."))
					if("Yes")
						if(usr.Yen>=src.Price)
							usr<<sound('SFX/click1.wav',0);usr<<sound('SFX/Cash.wav');usr<<"You bought a [src.name]!";usr.Yen-=src.Price
							var/obj/Scrolls/LearningScrolls/Slug_Summoning_Scroll/B=new();B.loc=usr
							return
						else
							usr<<"Not enough money!";usr<<sound('SFX/click2.wav',0)
					if("No")
			...
			Click()
				...
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Ryo. Do you want to buy it?", text) in list ("Yes","No."))
					if("Yes")
						if(usr.Yen>=src.Price)
							usr<<sound('SFX/click1.wav',0);usr<<sound('SFX/Cash.wav');usr<<"You bought a [src.name]!";usr.Yen-=src.Price
							var/obj/Scrolls/LearningScrolls/Toad_Summoning_Scroll/B=new();B.loc=usr
							return
						else
							usr<<"Not enough money!";usr<<sound('SFX/click2.wav',0)
					if("No")
...
// NINJA CASH STORE ITEMS
	...
	BattlePoints/Scrolls//Scroll category
		icon_state="Scroll"
		...
		Curry_of_Life
			...
			name = "Curry of Life"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CurryofLife/C=new(); C.loc=usr
		...
		EPBoost1
			Price = 25
			name = "Elemental Points +25"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/EPBoost1Scroll/D=new(); D.loc=usr
		...
		EPBoost2
			Price = 50
			name = "Elemental Points +50"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/EPBoost2Scroll/E=new(); E.loc=usr
		...
		SPBoost
			Price = 25
			name = "Starting Points +25"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/SPBoostScroll/E=new(); E.loc=usr
		...
		SPBoost2
			Price = 50
			name = "Starting Points +50"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/SPBoost2Scroll/E=new(); E.loc=usr
			...
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/Chakra10000/E=new(); E.loc=usr
		...
		SageModeApeJutsuBuy
			Price = 120
			name = "Sage Mode: Monkey"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/SageModeApeJutsuBuy/F=new(); F.loc=usr
			...
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/SageModeSlugJutsuBuy/E=new(); E.loc=usr
			...
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/SageModeLionJutsuBuy/E=new(); E.loc=usr
		...
		CursedSealHeaven
			Price = 80
			name = "CursedSeal: Heaven 1st Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSHJutsuBuy/H=new(); H.loc=usr
		...
		CursedSealEarth
			Price = 80
			name = "CursedSeal: Earth 1st Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSEJutsuBuy/I=new(); I.loc=usr
		...
		CursedSealFire
			Price = 80
			name = "CursedSeal: Fire 1st Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSFJutsuBuy/J=new(); J.loc=usr
		...
		CursedSealWater
			Price = 80
			name = "CursedSeal: Water 1st Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSWJutsuBuy/K=new(); K.loc=usr
		...
		CursedSealThunder
			Price = 80
			name = "CursedSeal: Thunder 1st Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSTJutsuBuy/L=new(); L.loc=usr
		...
		CursedSealAir
			Price = 80
			name = "CursedSeal: Air 1st Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSAJutsuBuy/M=new(); M.loc=usr
...
////////CS2
		CursedSealHeaven2
			Price = 120
			name = "CursedSeal: Heaven 2nd Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSHJutsuBuy2/N=new(); N.loc=usr
		...
		CursedSealEarth2
			Price = 120
			name = "CursedSeal: Earth 2nd Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSEJutsuBuy2/O=new(); O.loc=usr
		...
		CursedSealFire2
			Price = 120
			name = "CursedSeal: Fire 2nd Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSFJutsuBuy2/P=new(); P.loc=usr
		...
		CursedSealWater2
			Price = 120
			name = "CursedSeal: Water 2nd Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSWJutsuBuy2/Q=new(); Q.loc=usr
		...
		CursedSealThunder2
			Price = 120
			name = "CursedSeal: Thunder 2nd Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSTJutsuBuy2/R=new(); R.loc=usr
		...
		CursedSealAir2
			Price = 120
			name = "CursedSeal: Air 2nd Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSAJutsuBuy2/S=new(); S.loc=usr
		...
		CursedSealHell
			Price = 120
			name = "CursedSeal: Hell 1st Stage"
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSHellJutsuBuy/T=new(); T.loc=usr
			...
			Click()
				switch(input(usr,"The [src.name] costs [y2k_Uncondense_Num(src.Price)] Battle Points. Do you want to buy it?",text) in list ("Yes","No"))
					if ("Yes")
						if(usr.BattlePoints>=src.Price)
							usr<<"You bought a [src.name]!";usr.BattlePoints-=src.Price
							var/obj/BattlePoints/CSHellJutsuBuy2/W=new(); W.loc=usr
