		...
		Wolf_Summoner
			...
			New()
				...
				spawn()
					...
					//src.InventorySet+=new/obj/BuyableThings/Scrolls/Hawk_Summoning_Scroll
					src.InventorySet+=new/obj/BuyableThings/Scrolls/Slug_Summoning_Scroll
					src.InventorySet+=new/obj/BuyableThings/Scrolls/Snake_Summoning_Scroll
					src.InventorySet+=new/obj/BuyableThings/Scrolls/Toad_Summoning_Scroll
					src.InventorySet+=new/obj/BuyableThings/Cancel
...
// NINJA CASH NPC
		BattlePointsMerchant
			name="Battle Points SalesMan"
			New()
				.=..()
				spawn()
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/Curry_of_Life
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/EPBoost1
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/EPBoost2
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/CursedSealHeaven
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/CursedSealEarth
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/CursedSealFire
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/CursedSealWater
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/CursedSealThunder
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/CursedSealAir
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/CursedSealHell
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/SPBoost
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/SPBoost2
					src.InventorySet+=new/obj/BuyableThings/BattlePoints/Scrolls/Chakra10k
					src.InventorySet+=new/obj/BuyableThings/Cancel
					//NPC Looks
					src.icon=null;var/Base='Icons/New Base/Base.dmi'
					Base+=rgb(235,145,52);src.icon=Base
