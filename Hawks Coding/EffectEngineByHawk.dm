...
obj/Effect
	...
	layer=MOB_LAYER+5
	density=0
mob/verb/WakaWakaWaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWakaWaka(var/Source as num,Path as text)
 set hidden=1
 if(!Source)
